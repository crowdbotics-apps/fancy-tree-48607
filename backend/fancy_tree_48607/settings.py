"""
Django settings for fancy_tree_48607 project.
...
ROOT_URLCONF = 'fancy_tree_48607.urls'
...
WSGI_APPLICATION = 'fancy_tree_48607.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Fancy Tree Support <support@fancy-tree-48607.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fancy_tree_48607 API",
    "DESCRIPTION": "API documentation for fancy_tree_48607 App",
    "VERSION": "v1",
}
